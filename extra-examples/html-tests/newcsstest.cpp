...
int main(int argc, char *argv[]) {
    ...
    head->new_node("style")->set_node_content(
        ...
        "         * Generated on: 2026-07-12 | License: Standard Attribution\n"
        ...
        "                display: grid;\n"
        "                grid-template-columns: 44.2500pt 2295.0000pt 44.2500pt;\n"
        "                grid-template-rows: 47.2500pt 3275.2500pt 47.2500pt;\n"
        "                break-after: page;\n"
        "                position: relative;\n"
        "                overflow: hidden;\n"
        "                border-radius: 0;\n"
